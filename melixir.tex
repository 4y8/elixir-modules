...
\begin{itemize}
  ...
  \item We changed the syntax of module binding so that all the bindings are of the form (name = definition).
  \item Likewise the types of module bindings has been modified so that all the binding are of the form (name : definition\_type)
  \item Expression can be applied only to a list of names, and not to arbitrary expressions. It is however easy to encode the expression $E(E_1,...,E_n)$ as $\kwlet N_1 = E_1 \kwin ... \kwlet N_n=E_n\kwin E(N_1,\dots,N_n)$.
