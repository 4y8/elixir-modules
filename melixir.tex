...
%    & | & $t\wedge t$ & \aghilas{we can remove this one}\\
  ...
  %  &&&\color{bordeaux} Important: this allows maps and tuples to contain modules!\\
    ...
    $D$ & ::= & $X : \Lambda(\overline{\tx:\star}).\{\overline{D}\}_{\overline{\BX[\,\overline{\tx=t}\,]}}$                               &\color{Gray} exports a (possibly parametric) module $X$\\
    & | & $ X : t$    &\color{Gray} exports a module$X$ whose type is either a singleton or a behaviour or \texttt{mod}\\
    ...
    & | & $\tx : [=t]$                                  &\color{Gray} exports a transparent type $x = t$  \\[3mm]
       $\Gl$ & ::= & $\overline{X : \Lambda(\overline{\tx:\star}).\{\overline{D}\}_{\overline{\BX[\,\overline{\tx=t}\,]}}}$ &\color{Gray} global type environment\\
