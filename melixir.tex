  ...
  \begin{mathpar}
    \inferrule[Bind-DefModule]
       {\Sigma; \Gamma,\overline{P:*}\vdash\overline{B}:\overline{D}\\
        ...
        \forall S_i\in\overline{S} .\Sigma(S_i)=\overline{x_i:\star}\to \overline{D_i}\\
...
\begin{figure}
  \begin{mathpar}
    ...
    \inferrule[Path-SubModule]{\Sigma;\Gamma\vdash P:\left\{\_;\overline{D}\right\}\\
      D = \ldots, \kwdefm X\kwdo\overline{P} \overline{S} \overline{B} \kwend\\
      \overline{P} = \overline{\kwprm x}\\
      \Sigma;\Gamma\vdash\overline{t}
    }{\Sigma;\Gamma\vdash P.\left[\overline{x=t}\right]:\left\{\overline{S} ; \overline{\kwtp x=t}\, \overline{B} \right\}}
  \end{mathpar}
