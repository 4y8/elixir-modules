...
$X=\Lambda(\overline{x:\star}).{\{\ldots,\ty:\star,\ldots\}}_{\overline{\BX}}$, we
...
Plus the rules stating that a simple type other than path and behaviour is well-formed if all its components are well-formed.
  ...
  \beppe{Many modifications needed:\begin{itemize}\item well-formedness of paths must be done, and in two variants (according to whether we want instantiation at the end or at each step) \end{itemize}}
