...
\begin{figure}
  \begin{mathpar}
    \inferrule[WF-Field]{\Sigma;\Gamma\vdash P :
      \left\{\ldots,\kwtp x = t, \ldots\right\}\cup
      \left\{\ldots,\kwtp x = t, \ldots\right\}}
    ...
    \forall 0\leq i\leq n.\Sigma;\Gamma,\overline{N_i:T_i}^{i=1,\ldots,j}\vdash T_{j+1}}
    ...
    \forall i\neq j.\dom\left(\overline{D}^i\right)\#\dom\left(\overline{D}^j\right)\\
    \Sigma;\Gamma,\overline{\overline{x:\star}^i}\vdash\left\{\overline{D}\right\}}
              {\Sigma;\Gamma\vdash\left\{\overline{S_i};\overline{D}\right\}}\left(S\neq\epsilon\right)\\
