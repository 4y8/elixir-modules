...
Formally, we have the following definitions, where we replaced product types for record types.
\begin{definition}[Pretypes]\label{def:types}
  ...
  that are coinductively produced by
  \[
