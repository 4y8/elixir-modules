...
\end{itemize}
\aghilas{ points 1 and 4 are done, 3 is the usual semantics which is Guillaume's
  thesis, there is still a question for the encoding to core types: if $M.\tx$
  ...
  the syntax of declaration types to have: $\tx:[=\tau]$ would fix the issue.
}
