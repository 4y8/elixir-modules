...
\aghilas{ We have two different environments: $(1)$ the behaviour environment
  ...
  \begin{itemize}
    ...
    \item Good formation of types: $\Sigma;\Gamma\vdash t$ (Figure~\ref{wf-type});
    \item Good formation and typing of paths: $\Sigma;\Gamma\vdash M:\{\overline{D}\}$.
  \end{itemize}

  As pretypes are defined coinductively, we cannot give inductive rules for good
...
\begin{figure}[ht]
  \begin{mathpar}
    \inferrule[WFType-Behaviour]{\BX:\Lambda(\overline{\tx:\star}).\{\overline{D}\}\in\Sigma\\\overline{\Sigma;\Gamma\vdash t}}{\Sigma;\Gamma\vdash\BX[\overline{x=t}]}
    \inferrule[]{\\}{\\}
  \end{mathpar}
